...
Este é um serviço que oferece uma dashboard integrada para gerenciamento de segurança em uma ou várias contas AWS, permite também ativar checks de segurança.
