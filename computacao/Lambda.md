...
### Código e Funções
- Você escreve funções em linguagens como Python, Node, Java, etc. e faz o upload para o Lambda.

- Cada função tem um único propósito e será invocada quando o evento associado ocorrer.
...
### Versionamento e Alias
- O Lambda suporta versionamento de funções, permitindo que você mantenha diferentes versões do código e faça rollback se necessário.

	- O versionamento é a base principal para efetuação de deploys seguros e controlados, para mais informações, ler o tópico do [CodeDeploy](../automacao-e-aplicacoes/ci-cd/CodeDeploy.md#deploy-em-funções-lambda).
